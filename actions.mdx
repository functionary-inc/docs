...
| ----------------- | ------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------- |
| `modelProperties` | `{{modelProperties.fisrtName}}`      | All the properties EVER stored on the model. These are created by setting the `properties` value in a `api/v1/identify` call. |
